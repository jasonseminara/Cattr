...
Revision ID: 83105de19ba6
Revises: None
Create Date: 2015-12-27 09:18:13.542653

"""

# revision identifiers, used by Alembic.
revision = '83105de19ba6'
down_revision = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('avail_id', sa.Integer(), nullable=True),
    sa.Column('cat_id', sa.Integer(), nullable=True),
    sa.Column('host_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['avail_id'], ['availability.id'], ),
    sa.ForeignKeyConstraint(['cat_id'], ['cats.id'], ),
